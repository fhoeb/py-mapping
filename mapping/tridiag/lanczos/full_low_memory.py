"""
    ...
    All comments and docstrings for the Lanczos class apply equally here as well
"""
import numpy as np
    ...
    def _core_loop(self, cutoff):
        ...
        if not self.stable:
            for i in range(1, cutoff):
                ...
                self.A.dot(self.V[:, 1], out=self.w)
